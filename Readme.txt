/* *****   ЗАМЕЧАНИЯ  *******
--• архиватор занял 9.5Гб оперативной памяти для архивации файла в 8 Гб.
--• дублирование кода
--• архивация и распаковка смешана с процессом чтения и записи файлов
--• буфер прочитанных байт не выделен в класс
• потоки в целом работают последовательно потому что они выполняют работу под lock(this)
• запись файлов в одном потоке с cpu bound
***************************** */
